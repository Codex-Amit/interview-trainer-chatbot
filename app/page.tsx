    ...
    <main className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col">
        {!profile ? (
            ...
            <div className="w-full max-w-md">
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-muted-foreground">
                  ...
                  to provide tailored interview preparation based on your
          ...
          <div className="flex-1 max-w-4xl mx-auto w-full">
            <ChatInterface profile={profile} onReset={() => setProfile(null)} />
          </div>
        )}
      </div>
      ...
      <footer className="border-t border-border bg-card/30 py-4">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <p className="text-sm text-muted-foreground">
            Built with Next.js and Langflow | IBM Granite powered RAG |
